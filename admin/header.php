...
if(!defined('_MI_SPEECHSEARCH_NAME')) { // if modinfo isn't loaded, do it
...
function adminmenu($currentoption=0, $breadcrumb = "")
{
    ...
    $return .= "<td style='width: 60%; font-size: 10px; text-align: left; color: #2F5376; padding: 0 6px; line-height: 18px;'><a href=\"help.php\">"._AM_SPEECHSEARCH_ADMENU_HELP.'</a></td>';
